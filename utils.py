...
def plot_spectogram_amp(wav, path, pname):
    ...
    plot.title('Amplitutude Sample of a wav file with piano music')
    ...
    plot.savefig(path + pname + '_amp' + '.png')
    plot.close()


def plot_spectogram_spc(wav, path, pname):
    ...
    plot.savefig(path + pname + '_spec' + '.png')
    plot.close()
